...
import edu.cn.bookadminister.database.MD5Utils;
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(userName)){
                    Toast.makeText(RegisterActivity.this, "Please input the username", Toast.LENGTH_SHORT).show();
                    return;
                    ...
                    Toast.makeText(RegisterActivity.this, "The account name already exists", Toast.LENGTH_SHORT).show();
                    return;
                }else{
